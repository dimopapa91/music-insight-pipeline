...
def profile(username):
    ...
    return render_template_string(
        PROFILE_TEMPLATE,
        user=user, artists=artists,
        followers=followers, following=following, is_own=is_own,
    )
...
""" + _TOPBAR + """
    <div class="wrap">
        <div class="phead">
            ...
            {% if is_own %}<a href="/settings" class="editlink">Edit profile</a>{% endif %}
        </div>
        ...
        <div class="section">
            ...
            <p class="empty">The community feed is coming soon.</p>
        </div>
    </div>
</body>
</html>
